...
<pre style="position: relative;"><strong>Input:</strong> s = "ilovecodingonleetcode", target = "code"
...
<pre style="position: relative;"><strong>Input:</strong> s = "abcba", target = "abc"
...
<pre style="position: relative;"><strong>Input:</strong> s = "abbaccaddaeea", target = "aaaaa"
<strong>Output:</strong> 1
<strong>Explanation:</strong>
